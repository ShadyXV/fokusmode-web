            ...
            <div className="flex flex-col p-1.5 space-y-0.5">
              ...
              {hours.map((hour) => (
                <button
                  ...
                  className={`flex items-center justify-center py-2 text-sm rounded-md transition-colors ${selectedHour === hour
            ...
            <div className="flex flex-col p-1.5 space-y-0.5">
              ...
              {minutes.map((min) => (
                <button
                  ...
                  className={`flex items-center justify-center py-2 text-sm rounded-md transition-colors ${selectedMinute === min
                      ? "bg-amber-500 text-white font-medium shadow-sm shadow-amber-500/20"
                      : "hover:bg-white/10 text-muted-foreground"
                    }`}
                >
